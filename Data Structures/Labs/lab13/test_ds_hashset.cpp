...
typedef ds_hashset<std::string, hash_string_obj2> ds_hashset_type;
...
int main() {
  ...
  insert_result = set1.insert( std::string("cba") );  //added this...
  assert( insert_result.second );
