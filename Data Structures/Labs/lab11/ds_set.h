...
class ds_set {
public:
  ds_set() : root_(NULL), size_(0) { endElt = new TreeNode<T>(); }
...
template <class T> void ds_set<T>::accumulate(T& init_val){
